...
export default function RecentTransactionsPage() {
  ...
  const updateSearchParams = (payload: { locationId?: string; from?: string; to?: string; page?: number }) => {
                ...
                <Table className="table-auto">
                  ...
                  <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                    {transactions.map((txn) => (
                      <TableRow key={txn.id} className="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
