...
import { useFetchCustomer, useUpdateCustomer } from "../../hooks/useCustomers";
...
export default function EditCustomer() {
  ...
  if (isLoadingCustomer) {
    return <p className="p-6 text-center text-gray-500">Memuat data pelanggan...</p>;
  }

  return (
    <>
      <PageMeta title="Edit Member / Pelanggan" description="Halaman edit member dan pelanggan" />
      <PageBreadcrumb
        pageTitle="Edit Member"
        breadcrumbs={[{ label: "Grup Pelanggan & Member", path: "/customer-groups?tab=customers" }]}
      />
      <ComponentCard title="Form Edit Member">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
              ...
              <Button className="w-full sm:w-auto" size="sm" type="submit" disabled={isPending}>
                {isPending ? "Memperbarui Data..." : "Simpan Perubahan"}
              </Button>
            </div>
          </div>
        </form>
